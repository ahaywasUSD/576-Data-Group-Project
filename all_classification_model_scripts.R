...
# Plotting histograms
hist(df$Age, main="Age", xlab="Age", ylab="Frequency")
hist(df$Credit.Score, main="Credit Score", xlab="Credit Score", ylab="Frequency")
hist(df$Premium.Amount, main="Premium Amount", xlab="Premium Amount", ylab="Frequency")

# Density plots
plot(density(df$Age), main="Age", xlab="Age", ylab="Density")
plot(density(df$Credit.Score), main="Credit Score", xlab="Credit Score", ylab="Density")
plot(density(df$Premium.Amount), main="Premium Amount", xlab="Premium Amount", ylab="Density")
...
sd(df$Credit.Score)
var(df$Credit.Score)
summary(df$Premium.Amount)
sd(df$Premium.Amount)
var(df$Premium.Amount)
